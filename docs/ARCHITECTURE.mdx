...
- **[`TECHNICAL_DETAILS.md`](./TECHNICAL_DETAILS)** ⭐ - Ключевые технические детали: изоляция, деплой, SSH, метрики, архитектура сервисов
- **[`CONTRACTS_AND_VALIDATION.md`](./CONTRACTS_AND_VALIDATION)** - Детали системы контрактов и валидации
- **[`COMPARISON.md`](./COMPARISON)** - Сравнение Axion с CapRover и Convex, анализ недостающих функций
- **[`RUNNER_AGENT.md`](./RUNNER_AGENT)** ⭐ - Архитектура Axion Runner Agent для управления Docker Swarm на серверах
